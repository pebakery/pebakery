/*
    Copyright (C) 2018-2024 Hajin Jang
    ...
    public class CommandIniTests
    {
        ...
        public void IniRead()
        {
            ...
            try
            {
                ...
                ReadTemplate(s, CodeType.IniRead, $@"IniRead,{tempFile},Sec1,A,%Dest%,Default=Moo", tempFile, sampleStr, "1");
                ReadTemplate(s, CodeType.IniRead, $@"IniRead,{tempFile},Sec1,Cow,%Dest%,Default=Moo", tempFile, sampleStr, "Moo");
                ...
                ReadOptTemplate(s, CodeType.IniReadOp, new List<string>
                {
                    ...
                    $@"IniRead,{tempFile},Sec1,Cow,%Dest4%,Default=Moo",
                    $@"IniRead,{tempFile},Sec1,A,%Dest5%,Default=Moo",
